    ...
    return (
      ...
      <StatusBar barStyle="light-content" backgroundColor='crimson'/>
        <View style={{backgroundColor: 'crimson' }}>
          <Text style={{ fontSize: 35, fontWeight:'bold', alignSelf: 'center', color: '#fff' }}>{this.props.navigation.state.routeName}</Text>
        </View>
        <ScrollView style={{ padding: 15 }}>
          ...
          {productCard}
            ...
            <Button light title='Login' onPress={() => this.props.navigation.navigate('Login')} />
        <Footer />
      </>
    )
  }
